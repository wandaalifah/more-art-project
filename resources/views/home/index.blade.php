...
<div class="m-10 px-32">
    ...
    <div class="grid gap-y-8 gap-x-8 grid-rows-2 m-10 px-32">
        <div class="flex justify-center gap-x-8">
            <div class="relative group">
                <img class="w-64 rounded-3xl transition-transform duration-300 ease-in-out transform group-hover:scale-105" src="/image/Screenshot_9 (1).png" alt="SATU TUJU">
            ...
            <div class="relative group">
                <img class="w-96 rounded-3xl transition-transform duration-300 ease-in-out transform group-hover:scale-105" src="/image/Screenshot (225).png" alt="Aminlah Bersamaku">
                <div class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
        ...
        <div class="flex justify-center gap-x-8">
            <div class="relative group">
                <img class="w-96 rounded-3xl transition-transform duration-300 ease-in-out transform group-hover:scale-105" src="/image/Screenshot (209).png" alt="Garis Waktu">
                <div class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
                    <span class="text-white text-center">Garis Waktu</span>
                </div>
            </div>
            <div class="relative group">
                <img class="w-64 rounded-3xl transition-transform duration-300 ease-in-out transform group-hover:scale-105" src="/image/Screenshot (187).png" alt="Unpopular Kid">
                <div class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
    ...
    <div class="flex justify-end m-10 px-96">
