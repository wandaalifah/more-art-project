        ...
        <div class="grid gap-y-8 gap-x-8 grid-rows-2 m-10 px-32">
            <div class="flex justify-center gap-x-8">
                <div class="relative group hover:scale-110 transition-transform duration-300 ease-in-out">
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
                        <span class="text-white text-center font-dmSerif">Mahalini X Rizky Febian<br />Satu Tuju</span>
                    </div>
                </div>
                <div class="relative group hover:scale-110 transition-transform duration-300 ease-in-out">
                    <img class="w-96 rounded-3xl transition-transform duration-300 ease-in-out transform hover:bg-opacity-90"
                        src="/image/Screenshot (225).png" alt="Aminlah Bersamaku">
                    <div
                        class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
                        <span class="text-white text-center font-dmSerif">Aminlah Bersamaku</span>
                    </div>
                </div>
            </div>
            <div class="flex justify-center gap-x-8">
                <div class="relative group hover:scale-110 transition-transform duration-300 ease-in-out">
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
                        <span class="text-white text-center font-dmSerif">Garis Waktu</span>
                    </div>
                </div>
                <div class="relative group hover:scale-110 transition-transform duration-300 ease-in-out">
                    <img class="w-64 rounded-3xl transition-transform duration-300 ease-in-out transform hover:bg-opacity-90"
                    ...
                    <div
                        class="absolute inset-0 flex items-center justify-center text-yellow-600 bg-blue-900 bg-opacity-75 opacity-0 group-hover:opacity-100 rounded-3xl transition-opacity duration-300 ease-in-out">
                        <span class="text-white text-center font-dmSerif">Art Director<br />Unpopular Kid<br />Music
                            Video</span>
                    </div>
                </div>
            </div>
